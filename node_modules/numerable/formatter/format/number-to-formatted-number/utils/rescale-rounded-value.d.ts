 ...
 */
declare const rescaleRoundedValue: (value: number, currentAbbreviationScale: string | null, patternRules: NumberFormatRules, options: ResolvedNumerableFormatNumberOptions) => [scaledValue: number, abbreviationUnit: string | null];
