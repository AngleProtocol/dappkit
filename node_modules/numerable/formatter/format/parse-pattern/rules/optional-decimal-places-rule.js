...
const optionalDecimalPlacesRule = (patternMask) => {
    ...
    if (patternRegexpUtils.patternIncludes(patternMask, '[.]')) {
        optionalFractionDigits = true;
        outputPatternMask = patternRegexpUtils.patternReplace(outputPatternMask, '[.]', '.');
    }
    return [outputPatternMask, { optionalFractionDigits }];
};

module.exports = optionalDecimalPlacesRule;
