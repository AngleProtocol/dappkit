...
const signRule = (pattern) => {
    ...
    outputPatternMask = patternRegexpUtils.patternReplace(outputPatternMask, '(', `'ɵnps'`);
    outputPatternMask = patternRegexpUtils.patternReplace(outputPatternMask, ')', `'ɵnpe'`);
    outputPatternMask = patternRegexpUtils.patternReplace(outputPatternMask, /(-|\+)/, `'ɵs'`);
    return [outputPatternMask, { negativeParentheses, forceSign }];
};

module.exports = signRule;
