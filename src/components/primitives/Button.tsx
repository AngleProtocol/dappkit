...
export const buttonStyles = tv({
  base: "flex items-center select-none leading-none rounded-full text-nowrap font-text font-bold text-[clamp(15px,0.4167vw+0.78125rem,20px)]",
  variants: {
    look: {
      soft: "!p-0 lg:opacity-100 lg:hover:opacity-70 transition-opacity text-main-12 ease focus-visible:border-main-9",
