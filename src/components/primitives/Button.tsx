...
export const buttonStyles = tv(
  {
    base: "flex items-center dim !leading-none select-none rounded-full focus-visible:outline focus-visible:outline-accent-12 font-text ease font-bold text-[clamp(15px,0.4167vw+0.78125rem,20px)]",
    variants: {
      look: {
        soft: "text-gray-12 !p-0 active:text-accent-11 outline-offset-4",
        base: "text-accent-12 border-1 border-accent-11 active:border-accent-10",
        bold: "text-accent-1 bg-accent-11 active:bg-accent-10",
        tint: "text-accent-1 bg-gray-10 active:bg-gray-9",
        hype: "text-accent-1 bg-gray-11 active:bg-gray-10",
      },
      size: {
