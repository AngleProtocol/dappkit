...
export const buttonStyles = tv({
    ...
    variants: {
        look: {
            ...
            soft: "bg-main-0 border-main-0 hover:bg-main-4 active:bg-main-3 hover:text-main-12 hover:border-main-6 focus-visible:border-main-9",
...
export type ButtonProps = Component<typeof buttonStyles>

export default function Button({ look, size, ...props }: ButtonProps) {
    return <button type="button" className={buttonStyles({ look, size })} {...props} />
}